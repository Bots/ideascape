# ControlProof Project Headquarters

This page is the public engineering headquarters for ControlProof. GitHub Issues are the source of truth for engineering work; `PLAN.md` describes the broader product sequence.
